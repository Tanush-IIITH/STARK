...
OUTPUT_ROOT = "/home/keshav-goel/Desktop/AAD/STARK/Shift_or_bitap/results_extended"
...
def process_one_dataset(dataset_name):
    ...
    if seqs:
        ...
        # Monkey-patch reader in benchmark_extended
        import benchmark_extended
        benchmark_extended.read_fasta_file = lambda _: seqs
...
if __name__ == "__main__":
    ...
    print("Running EXTENDED for datasets 40 → 45:")
    for d in datasets:
        print(" -", d)
